...
const helpOptions: HelpOptions = {
    l: { type: "string", description: "Scrap a letter: all words starting with this letter (cannot be used with 'all' argument)", alias: [ "letter" ] },
    w: { type: "string", description: "Scrap a word and all it's definitions (cannot be used with 'all' argument)", default: false, alias: [ "word" ] },
    a: { type: "boolean", description: "Scrap all letters (cannot be used with 'letter' or 'word' argument)", default: false, alias: [ "all" ] },
...
const helpExamples: HelpExamples = [
    ...
    [ `npm run scrap:elix -- ${chalk.bold(`--word="eau de bouchain"`)}`, `Scrap the website for the word "eau de bouchain"` ],
